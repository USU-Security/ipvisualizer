...
enum opt{CONFIG_SERVER, CONFIG_PORT, CONFIG_LOCALNET, CONFIG_SUBNET, CONFIG_AUTH, CONFIG_INTERFACE, CONFIG_PCAPFILE, CONFIG_CONFIGFILE, CONFIG_LEFTCLICK, CONFIG_RIGHTCLICK, CONFIG_RIGHTNET, CONFIG_BLOCKNET, MAXOPTS};
